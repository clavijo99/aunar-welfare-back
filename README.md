...
```
git clone https://github.com/altixco/django-postgres-dokku aunar_welfare
cd aunar_welfare
```
...
```
dokku apps:create aunar_welfare
dokku postgres:create aunar_welfare
dokku postgres:link aunar_welfare aunar_welfare
```
...
```
dokku config:set aunar_welfare ENVIRONMENT=production DJANGO_SECRET_KEY=....
```
...
```
git remote add production dokku@<my-dokku-server.com>:aunar_welfare
```
